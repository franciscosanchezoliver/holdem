...
if __name__ == "__main__":
    while True:
        ...
        capturar_jugador_abajo(mesa_juego)
        capturar_izquierda_abajo(mesa_juego)
        capturar_izquierda_arriba(mesa_juego)
        capturar_arriba(mesa_juego)
        capturar_derecha_arriba(mesa_juego)
        capturar_derecha_abajo(mesa_juego)
